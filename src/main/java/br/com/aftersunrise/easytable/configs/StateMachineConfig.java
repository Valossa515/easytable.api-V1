...
public class StateMachineConfig extends EnumStateMachineConfigurerAdapter<PedidoStatus, PedidoStatusEvent> {
    ...
    public void configure(StateMachineTransitionConfigurer<PedidoStatus, PedidoStatusEvent> transitions)
        ...
        transitions
                ...
                .event(PedidoStatusEvent.CONCLUIR_PREPARO)
                .and()
                .withExternal()
                ...
                .and()
                .withExternal()
                .source(PedidoStatus.ENTREGUE).target(PedidoStatus.SOLICITADO_TROCA)
                .event(PedidoStatusEvent.SOLICITAR_TROCA)
                .and()
                .withExternal()
                .source(PedidoStatus.SOLICITADO_TROCA).target(PedidoStatus.EM_PREPARACAO)
                .event(PedidoStatusEvent.INICIAR_PREPARO)
                .and()
                .withExternal()
                ...
                .and()
                .withExternal()
                .source(PedidoStatus.SOLICITADO_TROCA).target(PedidoStatus.CANCELADO)
                .event(PedidoStatusEvent.CANCELAR);
    }
}
